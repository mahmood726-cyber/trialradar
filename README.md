...
1. Open `TrialRadar.html` in any browser
2. Select topics to monitor (15 pre-configured)
3. Click "Scan CT.gov"
4. Review alerts, trial registry, and ghost protocols
...
- **Dark/light theme**
- **Zero dependencies**, works offline after scan
