        # Trialradar: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/trialradar.git

        ## Objective

        TrialRadar is a clinical trial landscape monitoring tool that tracks ongoing and completed trials, maps evidence gaps, and alerts to new relevant results.
        ...
        - Code: https://github.com/mahmood726-cyber/trialradar.git
